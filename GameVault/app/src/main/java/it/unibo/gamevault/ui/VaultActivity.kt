...
class VaultActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
         ...
         */
        val vaultGames = listOf<VaultGamesModel>(VaultGamesModel("https://media.rawg.io/media/screenshots/623/623973e168a64a1f351a429d1f4db46c_iMXtnmX.jpg", "The Witcher: Rise of the white wolf", 4.0, "00/00/2020", "00/00/2020")) //TODO: gestire il take dei dati dal db
